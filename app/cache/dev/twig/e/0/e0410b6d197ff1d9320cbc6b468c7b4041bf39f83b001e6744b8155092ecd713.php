...
/* AdminBundle:Admin:wdfirselect.html.twig */
class __TwigTemplate_e0410b6d197ff1d9320cbc6b468c7b4041bf39f83b001e6744b8155092ecd713 extends Twig_Template
{
    ...
    {
        // line 1
        return $this->loadTemplate((($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "isXmlHttpRequest", array())) ? ("base.html.twig") : ("frontend.html.twig")), "AdminBundle:Admin:wdfirselect.html.twig", 1);
    }
   ...
   <div class=\"col-md-3\">
       <select class=\"form-control\" id=\"";
        ...
        foreach ($context['_seq'] as $context["prueba"] => $context["dato"]) {
            ...
            // line 11
            echo "          <option   value=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_wdfirtabla", array("id" => (isset($context["a"]) ? $context["a"] : $this->getContext($context, "a")))), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return "AdminBundle:Admin:wdfirselect.html.twig";
    }
